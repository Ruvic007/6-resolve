...
export default function StepCompany({ onNext, defaultValues, isFirstStep }) {
  ...
  const sousCategoriesOptions =
    categoriesData.find((cat) => cat.categorie === selectedCategorie)
      ?.sous_categories || [];
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="step-company-form">
      <div className="step-header">
        ...
        <h2 className="step-header-title">
          <Building2 size={22} /> Votre entreprise &amp; bâtiment
        </h2>
        <p className="step-description">
          Ces informations permettent de profiler votre site et d'adapter les
          simulations d'économies à votre secteur d'activité et à votre
          localisation.
        </p>
      </div>
      ...
      <div className="form-grid">
        ...
        <div className="field-group">
          ...
          />
          <small>
            Détermine votre zone climatique pour les simulations solaires
          </small>
          {errors.code_postal && (
      ...
      <div className="form-grid">
        <div className="field-group">
          ...
          {errors.categorie_activite && (
            <p className="error">{errors.categorie_activite.message}</p>
          )}
        </div>
        <div className="field-group">
        ...
        <div className="field-group">
          ...
          <div className="form-grid">
            <div className="field-group">
              ...
              />
              <small>
                Utilisée pour calculer votre potentiel solaire PV et thermique
              </small>
            </div>
          </div>
        </div>
      ...
      <div className="form-grid">
        <div className="field-group">
          <label>
            Type de bâtiment <span className="required">*</span>
          </label>

          <select
            {...register("type_batiment", { required: "Type obligatoire" })}
          >
            <option value="">-- Sélectionnez --</option>
        ...
        <div className="field-group">
          ...
          {errors.annee_construction && (
            <p className="error">{errors.annee_construction.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="form-grid">
        <div className="field-group">
          <label>
            Jours d'ouverture / semaine <span className="required">*</span>
          </label>
          <input
          ...
          {errors.jours_semaine && (
            <p className="error">{errors.jours_semaine.message}</p>
          )}
        </div>
        <div className="field-group">
          <label>
            Heures d'activité / jour <span className="required">*</span>
          </label>
          <input
          ...
          {errors.heures_par_jour && (
            <p className="error">{errors.heures_par_jour.message}</p>
          )}
        </div>
      </div>
